...
for i = 1:length(files)
    ...
    T(151:280,:) = flipud(T(151:280,:));
    T(431:560,:) = flipud(T(431:560,:));
    T(711:840,:) = flipud(T(711:840,:));
    T(991:1120,:) = flipud(T(991:1120,:));
    T(1271:1400,:) = flipud(T(1271:1400,:));
    T(1551:1680,:) = flipud(T(1551:1680,:));
...
N_rows = startsWith(strtrim(T.Well), 'N') & plate_rows & isnan(T.Batch);
